...
#uci set network.lan.dns='223.5.5.5 129.29.29.29'                         # DNS(多个DNS要用空格分开)
...
sed -i 's/192.168.1.1/10.0.0.1/g' package/base-files/files/bin/config_generate   # 修改openwrt登陆地址,把下面的192.168.2.2修改成你想要的就可以了
